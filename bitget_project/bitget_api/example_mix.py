...
if __name__ == '__main__':
    api_key = "bg_a602ba4551474c7b0f8472706dfef8fd"
    secret_key = "b18eacccf8f002edbbbba88ce7160c845a57e9d80777d8849f5d44c2deb8369c"
    passphrase = "bitgetapidh"  # 口令
    ...
    result = accountApi.account(symbol, marginCoin='USDT') #계좌 귀속 정보
    print(result["msg"])
    print(result["data"]["available"]) #사용가능USDT
    #"marginMode": "crossed"
    #"btcEquity": "0.0042349027"

    #result = accountApi.leverage(symbol, marginCoin='USDT', leverage=1, holdSide='long')
    #print(result)

    #result = accountApi.margin(symbol, marginCoin='USDT', amount=1, holdSide='long')
    #print(result)
    ...
    #result = accountApi.open_count(symbol, marginCoin='USDT', openPrice='3000', openAmount='500', leverage=1)
    #print(result)

    # result = accountApi.accounts('umcbl')
    # print(result)

    #  symbol,marginCoin,startTime,endTime,lastEndId = '',pageSize=20,next=False
    def bill():
        result = accountApi.accountBill(symbol, 'USDT',str(int(time.time()-86400 * 1000)), str(int(time.time() * 1000))) #24h
        print(result["data"])
